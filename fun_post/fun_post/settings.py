"""
Django settings for fun_post project.
...
SECRET_KEY = 'django-insecure-g7&i^%wy4q=)dh&le0wh@ya954=u&0@#mei73n_gr&7zp0*gt3'
...
WSGI_APPLICATION = 'fun_post.wsgi.application'
